...
--
-- Dumping data for table `jobcarditemscomment`
--

LOCK TABLES `jobcarditemscomment` WRITE;
/*!40000 ALTER TABLE `jobcarditemscomment` DISABLE KEYS */;
/*!40000 ALTER TABLE `jobcarditemscomment` ENABLE KEYS */;
UNLOCK TABLES;
