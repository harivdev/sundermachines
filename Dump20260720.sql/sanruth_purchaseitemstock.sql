...
--
-- Dumping data for table `purchaseitemstock`
--

LOCK TABLES `purchaseitemstock` WRITE;
/*!40000 ALTER TABLE `purchaseitemstock` DISABLE KEYS */;
/*!40000 ALTER TABLE `purchaseitemstock` ENABLE KEYS */;
UNLOCK TABLES;
