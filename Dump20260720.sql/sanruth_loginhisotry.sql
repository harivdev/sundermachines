...
--
-- Dumping data for table `loginhisotry`
--

LOCK TABLES `loginhisotry` WRITE;
/*!40000 ALTER TABLE `loginhisotry` DISABLE KEYS */;
/*!40000 ALTER TABLE `loginhisotry` ENABLE KEYS */;
UNLOCK TABLES;
