...
--
-- Dumping data for table `jobcarditemimage`
--

LOCK TABLES `jobcarditemimage` WRITE;
/*!40000 ALTER TABLE `jobcarditemimage` DISABLE KEYS */;
/*!40000 ALTER TABLE `jobcarditemimage` ENABLE KEYS */;
UNLOCK TABLES;
