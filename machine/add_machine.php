            ...
            <div class="machine-grid">
                ...
                <div class="jobcard-photo-wrapper">
                    ...
                    <div class="jobcard-photo-preview">
                        ...
                        <div id="noPhotoBox" class="no-photo-box">
                ...
                <div>
                    <div class="form-group-custom">
                        ...
                        <input type="text" id="machineName" name="machineName" class="form-input-custom" placeholder="e.g. BHARAT MOTOR REGULATOR" required>
                    </div>
