...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    echo "<script>alert('Machine Saved Successfully!');window.location='list_machine.php';</script>";
}
?>
...
<div class="machine-form-container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2 style="margin: 0; color: #0f172a; font-weight: 800; font-size: 22px;">Add New Machine</h2>
            ...
            <div class="machine-grid">
                ...
                <div class="image-upload-wrapper">
                    ...
                    <div class="image-preview-box" onclick="document.getElementById('machineImageInput').click();">
                        ...
                        <div id="placeholderBox" class="placeholder-content">
                ...
                <div>
                    <div class="form-group-custom">
                        ...
                        <input type="text" id="machineName" name="machineName" class="form-input-custom" placeholder="e.g. Heavy Duty Sewing Machine" required>
                    </div>

                    <div class="form-group-custom">
                        <label for="machineType">Machine Type</label>
                        <input type="text" id="machineType" name="machineType" class="form-input-custom" placeholder="e.g. Industrial / Automatic">
                    </div>

                    <div class="checkbox-group">
                        <input type="checkbox" id="assembled" name="assembled" value="1">
                    ...
                    <div class="btn-actions">
                        <button type="submit" class="btn-save">Submit Machine</button>
